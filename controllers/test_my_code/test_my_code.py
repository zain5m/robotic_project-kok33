...
class RobotController(Robot):
    ...
    def wait_motors_stopped(self, with_finger=False):
        ...
        while self.step(r.timestep) != -1:
            ...
            for motor, sensor in zip(motors, sensors):
                ...
                print(f"motor ------> {abs(current_position - target_position)}")
            ...
            if with_finger:
                ...
                print(f"finger ------>  {abs(current_finger_position - target_finger_position)}")
...
# r.arm3.setPosition(ARM_3_MAX_POSITION / 1.9)
# r.arm4.setPosition(ARM_4_MAX_POSITION / 1.55)
